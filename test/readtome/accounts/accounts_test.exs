defmodule Readtome.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{age: 42, email: "some email", name: "some name", sex: "some sex"}
    @update_attrs %{age: 43, email: "some updated email", name: "some updated name", sex: "some updated sex"}
